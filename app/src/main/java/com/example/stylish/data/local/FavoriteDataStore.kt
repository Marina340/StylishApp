...
class FavoriteDataStore(private val context: Context, private val username: String) {
//
//    companion object {
//        private val FAVORITES_KEY = stringSetPreferencesKey("favorite_product_ids")
//
//    }
    private val FAVORITES_KEY = stringSetPreferencesKey("${username}_favorite_product_ids")
